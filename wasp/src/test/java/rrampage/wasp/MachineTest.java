...
public class MachineTest {
    ...
    public void shouldPushConst() {
        ...
        Machine m = Machine.createAndStart(new Function[]{Function.createStartFunction("pushConst", startIns)}, null, null, MEM_PAGES, 0);
    ...
    public void shouldDrop() {
        ...
        Machine m = Machine.createAndStart(new Function[]{Function.createStartFunction("shouldDrop", ins)}, null, null, MEM_PAGES, 0);
        assertEquals(4, m.popInt());
    }
    ...
    public void shouldAdd() {
        ...
        Machine m = Machine.createAndStart(new Function[]{Function.createStartFunction("shouldAdd", ins)}, null, null, MEM_PAGES, 0);
    ...
    public void shouldAddAndCompare() {
        ...
        Machine m = Machine.createAndStart(new Function[]{Function.createStartFunction("shouldAddAndCompare", ins)}, null, null, MEM_PAGES, 0);
    ...
    public void shouldStoreAndLoad() {
        ...
        Machine m = Machine.createAndStart(new Function[]{Function.createStartFunction("shouldStoreAndLoad", ins)}, null, null, MEM_PAGES, 0);
    ...
    public void shouldCallIntConstFunction() {
        ...
        Machine m = Machine.createAndStart(new Function[]{fun, Function.createStartFunction("shouldCallIntConst", ins)}, null, null, MEM_PAGES, 1);
        assertEquals(m.popInt(), i);
    }
    ...
    public void shouldCallAddIntFunction() {
        ...
        Machine m = Machine.createAndStart(new Function[]{addFunction, Function.createStartFunction("shouldAdd", ins)}, null, null, MEM_PAGES, 1);
        assertEquals(m.popInt(), 1);
    }
    ...
    public void shouldLoopFunction() {
        ...
        Machine m = Machine.createAndStart(new Function[]{f, Function.createStartFunction("shouldLoop", ins)}, null, null, MEM_PAGES, 1);
        assertEquals(10, m.popInt());
    }
    ...
    public void shouldCallJavaMethod() {
        ...
        Machine m = Machine.createAndStart(new Function[]{fun, Function.createStartFunction("shouldCallJava", ins)}, null, null, MEM_PAGES, 1);
    ...
    public void shouldCallIndirectAddIntFunction() {
        ...
        Machine m = Machine.createAndStart(new Function[]{addFunction, Function.createStartFunction("shouldCallIndirect", ins)}, new Table[]{t}, null, MEM_PAGES, 1);
        assertEquals(m.popInt(), 1);
    }
