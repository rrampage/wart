...
public class PrimitivesTest {
    ...
    @TestFactory public Stream<DynamicTest> testF32() {return wastTest("f32.0.wasm", "f32.json");}
    @TestFactory public Stream<DynamicTest> testF64() { return wastTest("f64.0.wasm", "f64.json");}
}
